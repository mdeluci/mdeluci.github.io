...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/fig2_ch.png" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/fig3_ch.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Evolution of the phase-field from a randomly perturbed initial condition for $$\alpha=1500$$ and $$\bar{\phi}=0.3$$ (left). Evolution of the phase-field from a randomly perturbed initial condition for $$\alpha=3000$$ and $$\bar{\phi}=0.1$$ (right). 
</div>
